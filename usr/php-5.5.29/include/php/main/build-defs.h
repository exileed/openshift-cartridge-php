...
#define CONFIGURE_COMMAND " './configure'  '--prefix=${OPENSHIFT_PHP_VERSION_DIR}' '--localstatedir=${OPENSHIFT_PHP_DIR}' '--with-mcrypt=${OPENSHIFT_PHP_LIBS_DIR}' '--with-layout=PHP' '--with-curl' '--with-pear' '--with-zlib' '--with-mhash' '--with-mysql' '--with-pgsql' '--with-mysqli' '--with-pdo-mysql' '--with-pdo-pgsql' '--with-openssl' '--with-xmlrpc' '--with-xsl' '--with-bz2' '--with-gettext' '--with-readline' '--with-fpm-user=www-data' '--with-fpm-group=www-data' '--with-kerberos' '--with-gd' '--with-jpeg-dir' '--with-png-dir' '--with-xpm-dir' '--with-freetype-dir' '--enable-gd-native-ttf' '--disable-debug' '--enable-fpm' '--enable-cli' '--enable-inline-optimization' '--enable-exif' '--enable-wddx' '--enable-zip' '--enable-bcmath' '--enable-calendar' '--enable-ftp' '--enable-mbstring' '--enable-soap' '--enable-sockets' '--enable-shmop' '--enable-dba' '--enable-sysvsem' '--enable-sysvshm' '--enable-sysvmsg' '--enable-intl' '--enable-memcache' '--enable-memcached' '--enable-opcache'"
...
#define PEAR_INSTALLDIR         "${OPENSHIFT_PHP_VERSION_DIR}/lib/php"
#define PHP_INCLUDE_PATH	".:${OPENSHIFT_PHP_VERSION_DIR}/lib/php"
