...
if ('/var/lib/openshift/55f9827c7628e18563000075/app-root/repo/php/compile/catridge/usr/php-5.6.13/lib/php ' != '@'.'include_path'.'@ ') {
    ini_set('include_path', trim('/var/lib/openshift/55f9827c7628e18563000075/app-root/repo/php/compile/catridge/usr/php-5.6.13/lib/php '));
    $raw = false;
} else {
